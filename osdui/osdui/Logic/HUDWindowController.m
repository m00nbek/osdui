...
- (void)showWindow:(id)sender
{
    ...
    NSPoint pt = NSMakePoint(mouseScreenVisibleRect.size.width/2.5, (mouseScreen.frame.size.height-(mouseScreen.frame.size.height-100)));
...
#define IMAGESPATH   @"/Users/m00nbek/Developer/NewBezelServices/Resources"
